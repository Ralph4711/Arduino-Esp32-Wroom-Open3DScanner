 ...
 * bit 2 - SCROLL LOCK
 */
 #pragma GCC diagnostic ignored "-Wunused-variable" // Abschalten der Funktion - warning: unused variable 'value' [-Wunused-variable]
...
void ble_task_server(void*) {
    ...
    BLEDevice::init("Mein 3D Scanner");
...
void ble_take_photo() {
  ...
  vTaskDelay(100); // Wert musst du mal variieren, vielleicht reich auch 10?
